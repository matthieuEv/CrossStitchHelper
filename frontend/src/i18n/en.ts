...
export const en: Record<TranslationKey, string> = {
  ...
  "import.crop.hint": "Drag the four edges to keep only the grid.",
  "import.crop.detected": "Grid detected: {cols} × {rows} cells",
  "import.crop.redetect": "Detect again",
  "import.legend.hint": "{count} symbols recognised. Correct anything misread.",
  "import.legend.confidence": "{sure} confident · {unsure} to check",
  "import.legend.uncertain": "Uncertain reading",
  "import.legend.code": "DMC code",
  "import.legend.name": "Thread name",
  "import.legend.symbol": "Sym.",
  "import.legend.color": "Colour",
  "import.recap.source": "Pattern reassembled from {pages} PDF pages",
  "import.recap.size": "Size",
  "import.recap.stitches": "Stitches",
