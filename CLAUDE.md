...
**L'import ne lit toujours aucun fichier** (Lot 2, en cours). L'assistant se parcourt mais travaille sur un aperçu de démonstration. `frontend/src/demo/` reste utile au-delà de ça : c'est le repli hors-ligne de premier lancement quand ni le serveur ni le cache IndexedDB n'ont encore de motif.
