...
- La couleur et le symbole d'une case sont donc obtenus en identifiant **quelle image parmi les ~531 réutilisées** est placée à cette position — un problème de classification d'image sur un petit catalogue fermé d'icônes, très différent de la lecture d'un remplissage vectoriel (type B/C).
